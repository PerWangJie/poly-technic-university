<template>
  <div class="outDiv">
      ...
      <div class="top">
        ...
        <table border="1" style="text-align: left;margin: 0 auto;border-bottom: 0rem;color: #101010;border-collapse: collapse;width:100%;">
          ...
          <tr>
            ...
            <td style="text-align:left;" colspan="3">Specialty：{{roll.zy_en}}</td>
          </tr>
          <tr>
        ...
        <div class="table-div">
          <table style="line-height:0.3rem">
            ...
            <tr v-for="(item, index) in degreeList" :key="index">
              ...
              <td style="width:3.5rem;text-align:left">{{item.kcmc_en}}</td>
              <td style="width:1rem;text-align:left">{{item.jkxs}}</td>
              <td style="width:1rem;text-align:left">{{item.kcxf}}</td>
              <td style="width:1rem;text-align:left">{{item.kksj_en}}</td>
              <td style="width:0.6rem;text-align:left">{{item.khcj_en}}</td>
            </tr>
    ...
    <div class="bigDivs" @click="changeBig" v-show="big">
      <div class="top">
        <p>Transcript for Graduate Student of Zhejiang University of Technology</p>
...
.bigDiv {
  ...
  font-size: 0.26rem;
  background: url("../../assets/image/phone-bgEn.jpg") no-repeat;
